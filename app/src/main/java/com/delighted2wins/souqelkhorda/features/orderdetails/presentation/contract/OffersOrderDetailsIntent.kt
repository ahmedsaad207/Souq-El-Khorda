...
sealed class OffersOrderDetailsIntent {
    ...
    data class CancelOffer(val orderId: String, val offerId: String, val sellerId: String) : OffersOrderDetailsIntent()
    data class UpdateOffer(val offerId: String, val newPrice: String, val sellerId: String) : OffersOrderDetailsIntent()
    data class MarkAsReceived(val orderId: String, val offerId: String, val sellerId: String) : OffersOrderDetailsIntent()
}
